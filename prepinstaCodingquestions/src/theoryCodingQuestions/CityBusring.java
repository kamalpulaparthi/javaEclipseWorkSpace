...
public class CityBusring {
	
	public static void cal(String chs,String chs2) {
		
		float[]path= {800, 600, 750, 900, 1400, 1200, 1100, 1500};
		 String []bus= {"TH","GA","IC","HA","TE","LU","NI","CA"};
		 ...
		 {
			  if(chs2.equals(bus[i]))
			 {
				 l=i;
				 System.out.println(l);
			 }
			  if(chs.equalsIgnoreCase(bus[i]))
			 {
				 f=i;
			...
			System.out.println(Math.ceil(sum1/200)+"INR");
